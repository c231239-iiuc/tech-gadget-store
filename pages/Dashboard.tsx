...
const MOCK_ORDERS: Order[] = [
  ...
  },
  {
    ...
    total: 899.00,
    status: 'Shipped',
    items: [{ name: 'Smartphone X', quantity: 1, price: 899.00 }]
  },
  {
    id: 'ORD-1026',
    date: '2023-11-01',
    total: 49.50,
    status: 'Processing',
    items: [{ name: 'USB-C Hub', quantity: 2, price: 24.75 }]
  }
];
        ...
        <div className="border-t border-gray-200">
          <dl>
            ...
            <div className="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
              ...
              <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2 font-mono">{user?.uid}</dd>
            </div>
          </dl>
        </div>
      </div>
